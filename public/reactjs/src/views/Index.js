...
const technologies = [
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-material-ui.png",
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-sketch.png",
    description:
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-xd.png",
    description:
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-figma.png",
    description: "Figma helps teams create, test, and ship better designs from start to finish.",
    href: "https://www.creative-tim.com/product/argon-dashboard-pro-material-ui",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-react.png",
    description: "A JavaScript library for building user interfaces",
    href: "https://www.creative-tim.com/product/argon-dashboard-pro-react",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-bootstrap.png",
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-vue.png",
    description: "The Progressive JavaScript Framework",
    href: "https://www.creative-tim.com/product/vue-argon-dashboard-pro",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-nuxtjs.png",
    description:
      "Build your next Vue.js application with confidence using NuxtJS. An open source framework making web development simple and powerful.",
    href: "https://www.creative-tim.com/product/nuxt-argon-dashboard-pro",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-angular.png",
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-bootstrapvue.png",
    description:
    ...
    href: "https://www.creative-tim.com/product/bootstrap-vue-argon-dashboard-pro",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-laravel.png",
    description: "Laravel is a web application framework with expressive, elegant syntax.",
    href: "https://www.creative-tim.com/product/argon-dashboard-pro-laravel",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-react-native.png",
    description:
      "React Native combines the best parts of native development with React, a best-in-class JavaScript library for building user interfaces.",
    href: "https://www.creative-tim.com/product/argon-pro-react-native",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-nextjs.png",
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-nodejs.png",
    description: "Node.js® is a JavaScript runtime built on Chrome's V8 JavaScript engine.",
    href: "https://www.creative-tim.com/product/argon-dashboard-pro-nodejs",
  },
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-svelte.png",
  ...
  {
    image: "https://raw.githubusercontent.com/creativetimofficial/public-assets/master/icons-png/icon-flutter.png",
    description:
  ...
  return (
    <>
      ...
      <Box position="relative">
        <IndexHeader />
        <Box paddingTop="4.5rem" paddingBottom="10rem" component="section" className={classes.bgDefault}>
          <Container maxWidth={false}>
            <Grid container className={classes.centerElements}>
              <Grid item xs={12} md={6}>
                <Typography component="h2" variant="h2" className={classes.typographyH2}>
            ...
            <Grid container alignItems="center">
              ...
              <Grid item xs={12} md={6} className={classes.orderMd1}>
                <div className={classes.prMd5}>
                  ...
                  <Box component="p" fontWeight="300" lineHeight="1.7" fontSize="1rem" marginBottom="1rem" marginTop="0">
                    he kit comes with three pre-built pages to help you get started faster. You can change the text and images and you are good to go.
                  </Box>
                  <Box component="ul" marginTop="3rem" paddingLeft="0" className={classes.listStyleNone}>
                    <Box component="li" paddingTop=".5rem" paddingBottom=".5rem">
                      <Box display="flex" alignItems="center">
                        <div>
                          <Badge
                            badgeContent={<Settings />}
                            classes={{
                              badge: clsx(classes.badgePositionRelative, classes.badgeCircle, classes.badgeSuccess),
                            }}
                          ></Badge>
                        </div>
                        <div>
                          <Typography variant="h4" component="h4" className={classes.typographyH4}>
        ...
        <Box paddingTop="6rem" paddingBottom="6rem" component="section" overflow="hidden" className={classes.bgWhite}>
          <Container maxWidth="xl">
            <Grid container className={classes.justifyContentCenter}>
              <Grid item xs={12} lg={8} className={classes.textCenter}>
                ...
                <Box component="p" fontWeight="300" lineHeight="1.7" fontSize="1.25rem" marginBottom="1rem" marginTop="1.5rem">
                ...
                <Box marginTop="3rem">
                  ...
                  <Button component="a" target="_blank" variant="contained" color="default" href="https://nucleoapp.com/?ref=1712">
                    View all icons
                  </Button>
                </Box>
              </Grid>
            ...
            <Box position="relative" className={classes.blurWrapper}>
              <a href="https://www.creative-tim.com/learning-lab/material-ui/icons/argon-dashboard?ref=adpmui-index-page" target="_blank">
                <Box marginTop="3rem!important" className={classes.blurItem}>
                  <i className={clsx(classes.iconNi, "ni ni-diamond")}></i>
                  <i className={clsx(classes.iconNi, "icon-sm ni ni-album-2")}></i>
                  ...
                  <i className={clsx(classes.iconNi, "icon-sm ni ni-briefcase-24")}></i>
                  <i className={clsx(classes.iconNi, "icon-sm ni ni-building")}></i>
                  <i className={clsx(classes.iconNi, "icon-sm ni ni-button-play")}></i>
                  <i className={clsx(classes.iconNi, "ni ni-calendar-grid-58")}></i>
                  <i className={clsx(classes.iconNi, "ni ni-camera-compact")}></i>
                  <i className={clsx(classes.iconNi, "ni ni-chart-bar-32")}></i>
                </Box>
                <Typography component="span" variant="h5" className={classes.blurHidden}>
        ...
        <Box paddingTop="6rem" paddingBottom="6rem" component="section">
          <Container maxWidth="xl">
            <Grid container className={classes.justifyContentCenter}>
              <Grid item xs={12} lg={8} className={classes.textCenter}>
                <Typography component="h2" variant="h2" className={classes.typographyH2}>
                  <Box component="span" display="block" color={theme.palette.dark.main}>
                    Do you love this awesome
                  </Box>
                  <Box component="span" fontWeight="300" display="block" color={theme.palette.info.main}>
                    Dashboard for Material-UI, React and React Hooks?
                  </Box>
                </Typography>
                <Box component="p" fontWeight="300" lineHeight="1.7" fontSize="1.25rem" marginBottom="2rem" marginTop="1.5rem">
                  Based on the license you get, you will have direct access to our team of developers who built the product.
                </Box>
                {/*<Box marginTop="3rem">
                  <Button
                    component="a"
            ...
            <Grid container alignItems="center" className={classes.justifyContentCenter}>
              <Grid item xs={12} lg={4} className={classes.paddingLg0}>
                <Card elevation={0}>
                  ...
                  <CardContent classes={{ root: classes.cardContentRoot }}>
                    <Box component="ul" paddingLeft="0" className={classes.listStyleNone} display="inline-flex" flexDirection="column" margin="0">
                      <Box component="li" paddingTop=".5rem" paddingBottom=".5rem" display="inline-flex" alignItems="center">
                        <Box component={Done} width="1.5rem!important" height="1.5rem!important" />
                        <Typography variant="h4" component="h4" className={classes.typographyH4}>
                          1 Developer
                        </Typography>
                      </Box>
                  ...
                  <Box component={CardActions} justifyContent="center" className={classes.cardActionsRoot}>
                    <Button
                      elevation={0}
                      component="a"
                      variant="contained"
                ...
                <Card elevation={0} className={classes.middleCard}>
                  <CardHeader
                    ...
                    subheaderTypographyProps={{
                      variant: "h1",
                      component: "h1",
                      className: clsx(classes.typographyH1Pricing, classes.textWhite),
                    }}
                    titleTypographyProps={{
                      variant: "h5",
                      component: "h5",
                      color: "textSecondary",
                      className: clsx(classes.typographyH5Pricing, classes.textWhite),
                    }}
                  ></CardHeader>
                  <CardContent classes={{ root: classes.cardContentRoot }}>
                    <Box
                    ...
                    >
                      <Box component="li" paddingTop=".5rem" paddingBottom=".5rem" display="inline-flex" alignItems="center">
                        <Box component={Done} width="1.5rem!important" height="1.5rem!important" />
                        <Typography variant="h4" component="h4" className={clsx(classes.typographyH4, classes.textWhite)}>
                          Up to 10 Developers
                        </Typography>
                      </Box>
                      <Box component="li" paddingTop=".5rem" paddingBottom=".5rem" display="inline-flex" alignItems="center">
            ...
            <Grid container className={classes.justifyContentCenter}>
              <Grid item xs={12} lg={8} className={classes.textCenter}>
                <Box textAlign="center">
                  <Typography variant="h4" component="h4" className={classes.typographyH4Display4}>
                    ...
                    {technologies.map((prop, key) => (
                      <Grid key={key} item xs={3} md={2}>
                        <Box marginTop=".5rem" marginBottom=".5rem">
                          <Tooltip title={prop.description} placement="top" arrow>
                            <a href={prop.href + "?ref=adpmui-index-page"} target="_blank">
                              <Box component="img" src={prop.image} alt="..." borderRadius="50%" className={classes.imageBadge}></Box>
                            </a>
                          </Tooltip>
                        </Box>
                      </Grid>
